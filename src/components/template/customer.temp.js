...
const API_URL = API + 'templates/editcustomer/';
const API_URL_SAVE = API + 'templates/editcustomer/';
...
class AddBill extends Component {
    ...
    componentDidMount() {
        ...
        .then(response => {
            ...
            customer_name:response.data.cus.customer_name,
             customer_address:response.data.cus.customer_address,
            });
        })
    ...
    editTemplate(event) {
        ...
        Axios.post(API_URL_SAVE , template, { headers: { Authorization: localStorage.getItem('token') } })
          .then(response => {
