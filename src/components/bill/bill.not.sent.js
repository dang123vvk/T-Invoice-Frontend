...
import {  Table, TableHead, TableRow, TableCell, TableBody, Fab, Tooltip, TablePagination, TableFooter, AppBar, Toolbar, Grid, Button, TextField, Typography } from '@material-ui/core';
...
import { getBillUserCurrent, getBillUserCurrentSearch, getBillUserCurrentFilter, getBillNotSendLength } from '../share/services/bill.service';
class ResultBillNotSent extends React.Component {
    _exporter;
    export = () => {
        this._exporter.save();
    }
...
export default connect(mapStateToProps)(ResultBillNotSent);