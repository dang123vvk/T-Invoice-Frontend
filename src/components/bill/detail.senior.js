...
import EditIcon from '@material-ui/icons/ArrowBack';
...
class DetailBillSenior extends Component {
    ...
    componentDidMount() {
        getBillSeniorId(this.props.match.params.id, this.props.user_username, this.props.role,this.props.token).then(data => {
            this.setState({
                data: data.items,
                            ...
                            <Container component="main" maxWidth="sm" >
                                <Paper elevation={0}  style={{ marginTop: '2%'}} >
                                    <Breadcrumbs aria-label="Breadcrumb" separator="/">
                                        ...
                                        <Link style={{ color: '#3f51b5' }} to="senior/bills" >
                                            Bills
                                        </Link>
                                ...
                                <Grid container spacing={3} >
                                    ...
                                    <Grid item xs={12} sm={6} >
                                        <Tooltip title="Back">
                                            <Link to='/senior/bills'><Button variant="contained" color="primary" >
                                                <EditIcon />
                                             Back
                                        </Button>
                                            </Link>
