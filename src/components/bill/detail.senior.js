...
const CustomFooter = (props) =>
    (`Total `);
class DetailBillSenior extends Component {
    pdfExportComponent;
    _exporter;
    export = () => {
        this._exporter.save();
    ...
    componentDidMount() {
        ...
        Axios.get(API_URL_SENIOR + this.props.match.params.id + '/' + localStorage.getItem('user_id'), { headers: { Authorization: localStorage.getItem('token') } })
            .then(response => {
                this.setState({
                            ...
                            <Container component="main" maxWidth="sm" >
                                <Grid container spacing={3} >
                                    ...
                                    <Grid item xs={12} sm={4} >
                                        <Tooltip title="Return Dashboard Group">
                                            <Link to='/senior'><Button variant="contained" color="secondary" >
                                            Group
                                        </Button>
                                            </Link>
                                        </Tooltip>
...
export default connect(mapStateToProps)(DetailBillSenior);