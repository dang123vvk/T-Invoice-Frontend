...
import { Button, TextField, Paper, Breadcrumbs } from '@material-ui/core';
...
const API_URL_CUSTOMER = API + 'customers/edit/';
...
class AddBillCustomer extends Component {
    constructor(props) {
        super(props);
        this.state = {
            columns: [
    ...
    componentDidMount() {
        ...
        Axios.get(API_URL_TEMPLATE_CUS +  this.props.match.params.id, { headers: { Authorization: localStorage.getItem('token') } })
        .then(response => {
            this.setState({
        ...
        Axios.get(API_URL_ACCOUNTSBANK,{ headers: { Authorization: localStorage.getItem('token') } })
            ...
            .catch(err => console.log(err));
        Axios.get(API_URL_CUSTOMER+ this.props.match.params.id + '/'+ localStorage.getItem('user_id'),{ headers: { Authorization: localStorage.getItem('token') } })
            .then(response => {
                if(response.data.status_po_nos_add == true)
                {
                    this.setState({ 
                        customer_id: response.data.customers.customer_id,
                        ...
                        bill_reference: (this.state.month_1+response.data.customers.customer_swift_code).toUpperCase(),
                        swifcode: response.data.customers.customer_swift_code,
                        display_po: false,
                     });
                }
                else {
    ...
    handleChangeBillMonthlyCost(event) {
        ...
        this.setState({
            ...
            bill_reference: (month(month2)+value.slice(0,4)+this.state.swifcode).toUpperCase(),
        });
    }
    handleChange(event) {
        this.setState({
                            ...
                            <Grid item xs={6} >
                                ...
                                <Grid container spacing={3}>
                                    ...
                                    <Grid item xs={6} align-content-xs-flex-end="true" >
                                        <Typography style={{ fontWeight: 'bold', fontSize: '20px' }} align="right">
                                        <Input
                                    ...
                                    <Grid item xs={12} >
                                        <Typography style={{ fontSize: '15px', fontWeight: 'bold' }} align='left'><br />  <Input
                                                style={{ width: '40%',fontSize:'13px'}}
                                                type="text"
                                    ...
                                    <Grid item xs={12} >
                                        <Typography style={{ fontSize: '15px', fontWeight: 'bold' }} align='left'> <Input
                                                style={{ width: '40%',fontSize:'13px'}}
                                                type="text"
                                        ...
                                        <Input
                                            ...
                                            <Input
                                                ...
                                                required
                                            /></Typography>
                                        <Typography style={{ fontSize: '15px', fontWeight: 'bold' }} align='left'>Email: <Input
                                                style={{ width: '20%',fontSize:'13px'}}
                                                type="text"
                                    ...
                                    <Grid item xs={4} >
                                        <Typography style={{ fontSize: '15px', fontWeight: 'bold' }} align='center'>
                                            <Button fullWidth type="button" style={{ backgroundColor: 'red', color: 'white'}} size="large" color="primary" variant="contained" onClick={this.cancel}>Cancel</Button>
                                        </Typography>
                                    </Grid>
                                    <Grid item xs={4} >
                                        <Typography style={{ fontSize: '15px', fontWeight: 'bold' }} align='center'>
...
const mapStateToProps = state => {
  ...
  export default connect(mapStateToProps) (AddBillCustomer);