...
export function getCustomerSearch(text_search){
    return axios.get(API_URL + 'customers/'+user_information.user_username+'/search/'+text_search,{ headers: { Authorization: user_information.token } } ).then(res => res.data);
}
